...
public class VigenereCipherAdaptation extends Cipher {
	/**
	 * This function will to encrypt the original text with key follow cipher technique with assignment requirement
	 */
	@Override
	...
	/**
	 * This function uses to decrypt the encrypted text into original text with key follow cipher technique with assignment requirement
	 */
	@Override
